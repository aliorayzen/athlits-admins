...
export const courtConfigurationApi = {
  ...
  listRules: (venueId: string, courtId: string, signal?: AbortSignal) => request<CourtRuleResponse[]>(adminEndpoints.courtRules(venueId, courtId), undefined, signal),
  ...
  listSports: (venueId: string, courtId: string, signal?: AbortSignal) => request<CourtSportResponse[]>(adminEndpoints.courtSports(venueId, courtId), undefined, signal),
  ...
  listEquipment: (venueId: string, courtId: string, sportId: string, signal?: AbortSignal) => request<EquipmentResponse[]>(adminEndpoints.courtEquipment(venueId, courtId, sportId), undefined, signal),
  ...
  listPricing: (venueId: string, courtId: string, sportId: string, signal?: AbortSignal) => request<PricingRuleResponse[]>(adminEndpoints.courtPricing(venueId, courtId, sportId), undefined, signal),
