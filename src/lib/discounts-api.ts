...
export const discountsApi = {
  list: async (venueId: string, signal?: AbortSignal) => normalizeListResponse<VenueDiscountResponse>(await request<unknown>(adminEndpoints.venueDiscounts(venueId), { signal }), "Venue discounts"),
  ...
  listPromotions: async (venueId: string, signal?: AbortSignal) => normalizeListResponse<VenuePromotionResponse>(await request<unknown>(adminEndpoints.venuePromotions(venueId), { signal }), "Venue promotions"),
